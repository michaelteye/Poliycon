                        ...
                        <div className="flex flex-col text-white">     
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Accra, Greater Accra,Ghana</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="https://www.linkedin.com/company/policycon/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
